// var lead_source = window.localStorage.getItem("_fm_ls") || "";
...
//         } else {
//             lead_source = referrer !== "" ? referrer : (utm_source !== "" ? utm_source : "social");
//         }
...
//                 input.setAttribute("value", lead_source);
...
//                 input.setAttribute("value", lead_medium);
...
//                 input.setAttribute("value", lead_campaign);
...
//                 input.setAttribute("value", google_click_id);
...
//                 input.setAttribute("value", fb_click_id);
...
//                 input.setAttribute("value", ga_client_id);
//             } else {
//                 replaced = false;
//             }
...
function normalizeSocialSource(source) {
    ...
    if (s === "x" || s === "x.com" || s.indexOf("x.com") >= 0 || s === "twitter" || s.indexOf("twitter") >= 0) {
        return "twitter";
    }
...
if (lead_source === "") {
    ...
    var paid_social_medium =
        ...
        utm_medium.indexOf("paid_social") >= 0 ||
        utm_medium.indexOf("paid+social") >= 0 ||
        (utm_medium.indexOf("ppc") >= 0 && social_media.includes(utm_source)) ||
        (utm_medium.indexOf("cpc") >= 0 && social_media.includes(utm_source)) ||
        (utm_medium.indexOf("cps") >= 0 && social_media.includes(utm_source)) ||
        (/\bpaid\b/.test(utm_medium) && social_media.includes(utm_source));
    ...
    if (google_click_id !== "") {
        ...
        (utm_source === "google" || utm_source === "google_ads" || utm_source.replace(/\+/g, "_") === "google_ads") &&
        (utm_medium.indexOf("paid_search") >= 0 || utm_medium.indexOf("paid+search") >= 0 || utm_medium.indexOf("paid search") >= 0 || utm_medium.indexOf("paid ads") >= 0 || utm_medium.indexOf("ppc") >= 0 || utm_medium.indexOf("cpc") >= 0 || utm_medium.indexOf("cps") >= 0)
    ) {
        lead_source = "google";
        lead_medium = "paid search";
    } else if (
        ...
        ((utm_medium.includes("paid") || utm_medium.includes("ppc") || utm_medium.includes("cpc")) &&
            ...
            utm_medium.indexOf("paid_search") < 0 &&
            utm_medium.indexOf("paid+search") < 0 &&
            (social_media.includes(utm_source) || social_media.includes(referrer)))
    ) {
        lead_medium = "paid social";
        if (social_media.includes(utm_source)) {
            lead_source = normalizeSocialSource(utm_source);
        ...
        lead_medium = "paid search";
        if (utm_source.indexOf("adword") >= 0 || utm_medium.indexOf("adword") >= 0 || utm_campaign.indexOf("adword") >= 0) {
            lead_source = "google";
        } else if (referrer !== "") {
            lead_source = referrer;
        } else {
